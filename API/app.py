...
def tab3_calibrar():
    ...
    def procesar():
        try:
            ...
            # [DETERMINISTA OPTIMIZADO] Muestreo sistemático uniforme estricto a 145 épocas
            step = max(1, total_eps // 145)
            ...
            yield f"  [-] Épocas estadísticas a evaluar: {len(t_sample)} (Criterio: 1 época tomada cada {step} épocas, límite exacto 145)\n"
